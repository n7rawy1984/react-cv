...
const CV_Combined_ModerateExperience = () => {
  ...
  const cvData = {
    personalInfo: {
      ...
      title: "Accounting Professional | Aspiring Web Developer",
      contact: {
    ...
    summary:
      "Adaptable professional with 15+ years of experience in accounting, data analysis, and operational support. <strong>Currently learning web development</strong> (HTML, CSS, JavaScript, React, Next.js) while maintaining expertise in financial management. <strong>Fast learner with strong problem-solving skills</strong>, eager to apply both traditional business skills and modern programming knowledge. Bilingual in English and Arabic, with a focus on attention to detail and continuous learning.",
    education: {
  ...
  return (
    <div className="app-container">
      ...
      <div className="export-buttons">
        ...
        <button onClick={copyForWord} className="export-btn word-btn">
          <i className="fas fa-file-word"></i> Copy for Word
        </button>
      </div>
